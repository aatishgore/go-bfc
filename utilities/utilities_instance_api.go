...
// GenerateTicketNumber is generate a ticket number
func GenerateTicketNumber() string {
	now := time.Now()
	nano := now.Nanosecond()
	randum := "INC" + strconv.Itoa(nano/1000)
	return randum
}
